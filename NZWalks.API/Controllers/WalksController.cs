...
namespace NZWalks.API.Controllers
{
    ...
    public class WalksController : ControllerBase
    {
        ...
        //GET /api/walks?filterOn=Name&FfilterQuery=Track&sortBy=Name&pageNumber=1&pageSize=10
        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] string? filterOn, [FromQuery] string? filterQuery,
            [FromQuery] string? sortBy, [FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 1000) 
        {
            var walksDomainModel = await walkRepository.GetAllAsync(filterOn,filterQuery,pageNumber, pageSize);
